 ...
 * más vendidos y su ganancia correspondiente.
 * 
 * @module components/modules/reportes/GraficoProductosMasVendidos
 ...
 * @returns {JSX.Element} Componente GraficoProductosMasVendidos
 */
const GraficoProductosMasVendidos = ({ datos }) => {
  // Ordenar datos por cantidad vendida (descendente)
  const datosOrdenados = [...datos]
    .sort((a, b) => b.cantidad - a.cantidad)
    .slice(0, 10); // Mostrar solo los 10 más vendidos
      ...
      return (
        <div className="bg-white p-4 border border-gray-200 shadow-md rounded-md">
          ...
          <p className="text-green-600">
            <span className="font-medium">Ventas:</span> {formatearMoneda(payload[1].value)}
          </p>
          <p className="text-orange-600">
            <span className="font-medium">Ganancia:</span> {formatearMoneda(payload[2].value)}
          </p>
...
GraficoProductosMasVendidos.propTypes = {
